...
std::set<T> mapf(F &&f, std::set<T> const &s)
{
    std::set<T> r;
...
auto foldl_v(F &&f, T1 arg1, T2 arg2)
{
    return f(arg1, arg2);
}

template <typename F, typename T, typename ...Ts>
auto foldl_v(F &&f, T head, Ts ...rest)
{
    return f(head, foldl_v(std::forward<F>(f), rest...));
}

template <typename F, typename T1, typename T2>
auto foldr_v(F &&f, T1 arg1, T2 arg2)
{
    return f(arg2, arg1);
}

template <typename F, typename T, typename ...Ts>
auto foldr_v(F &&f, T head, Ts ...rest)
{
